            ...
            <div className="collapse navbar-collapse" id="mynavbar">
              <ul className="navbar-nav ms-auto ">
                {navbar.map((item, index) => (
                  <li
                    key={index}
                    className={`nav-item mt-1 ms-3 fw-bold ${
                      props.value == index ? "active" : ""
                    }`}
                  >
                ...
                <li className="nav-item ms-3">
                  ...
                  >
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="bi bi-search text-white mt-2 ms-2"
                      viewBox="0 0 16 16"
                    >
                ...
                <li className="nav-item">
                  <Dropdown>
                    ...
                    >
                      <div className="d-flex">
                        <svg
                          ...
                          height="16"
                          fill="currentColor"
                          className="bi bi-cart text-white mt-2 ms-3"
                          viewBox="0 0 16 16"
                        >
                          <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l1.313 7h8.17l1.313-7zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2" />
                        </svg>
                        <span className="bg-warning cart-text d-flex align-items-start pb-3 justify-content-center">
                    ...
                    <Dropdown.Menu className="border-0 mt-4">
                        ...
                        cart.map((item, index) => (
                          ...
                          >
                            <div className="row m-0 w-100 text-wrap">
                              ...
                              <p className="col-4 ps-5">${item.price}.00</p>
                            </div>
                          </DropdownItem>
                        ))
                      ) : (
                      ...
                      <Link to="/cart">
                        <button className="btn btn-outline-dark ms-4 fs-6">
                          CheckOut ({cart != undefined ? cart.length : ""})
                        </button>
                      </Link>
                    </Dropdown.Menu>
                  </Dropdown>
                ...
                <li className="nav-item ms-3">
                  <button
                    type="button"
                    className="btn btn-outline-light rounded-pill ps-4 pe-4"
                  >
                    Donate
                  </button>
                </li>
