  ...
  return (
    <div>
      ...
      <div className="row w-100 m-0">
          ...
          <div className="d-flex justify-content-center align-items-center h-100">
            <div className="w-65 color">
              ...
              <div className="d-flex mt-5">
                <Link to="/contact">
                  <button className="btn btn-warning color rounded-pill btn-join fm">
                    Join Us
                  </button>
                </Link>
                <Link to="/about" className="mt-2">
                  <button className="btn color btn-find fn">
                    Find Out More
                  </button>
                </Link>
              </div>
        ...
        <img
          src="src/components/images/1-2.jpg"
          className="col-6 image-join p-0"
        />
      </div>
      <div className="row w-100 m-0">
        <img
          src="src/components/images/6-1.jpg"
          className="col-6 image-join p-0"
        />
        <div className="col-6 content-join">
          <div className="d-flex justify-content-center align-items-center h-100">
      ...
      <div className="row w-100 m-0">
        ...
        <img
          src="src/components/images/2-2.jpg"
          className="col-6 image-join p-0"
        />
      </div>
      <div className="row w-100 m-0">
        <div className="col-6 befooter1">
          <div className="d-block w-40">
            ...
            <p className="fs-5 mt-4">
              Those who wish to join Green Planet are invited to commit
              themselves to become founding members of the network by completing
              the form accompanying this announcement.
            </p>
            <button className="btn fw-bold mt-5 p-0 btn-help">
              Help company
            </button>
          </div>
        </div>
        <div className="col-6 befooter2">
          <div className="d-block w-40">
            ...
            <button className="btn fw-bold mt-5 p-0 btn-view">
              View all campaigns
            </button>
          </div>
        </div>
