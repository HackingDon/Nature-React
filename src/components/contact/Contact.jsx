        ...
        <div className="col-7 p-0">
          <div className="d-flex align-items-center flex-column justify-content-center h-100 w-100">
            <div className="w-55">
              ...
              <p className="text-secondary fs4 mt-3">
                If you have any questions about Green Planet, please do not
                hesitate to contact .
              </p>
              <form className="text-secondary">
                <div className="d-flex gap-5 mt-4">
                  <label className="w-50 fw-bold">
                    ...
                    <input
                      ...
                      className="form-control border border-dark-subtile rounded-4 p-2"
                    />
                  </label>
                  <label className="w-50 fw-bold">
                    Email{" "}
                ...
                <label className="w-100 fw-bold mt-5">
                  Message <br />{" "}
                  <textarea
                    placeholder="Your Message"
                    style={{ height: "200px" }}
                    className="form-control w-100 border border-dark-subtile rounded-4"
                  ></textarea>
                </label>
                <button className="btn btn-join btn-warning rounded-pill text-white mt-4">
                  Send Message
                </button>
              </form>
            </div>
