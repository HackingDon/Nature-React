    ...
    <div>
      ...
      <div className="slider w-100">
        ...
        <div className="slider-con">
          ...
          <button className="btn btn-outline-warning db rounded-pill mt-4">
            Learn More
          </button>
        </div>
        ...
        <div className="col-lg-8 bg-col h-100">
          <div className="d-flex justify-content-center align-items-center h-100">
            <div className="w-55 color">
              <h1 className="fw-bolder fs1 fn">
                You Have The Power Today to change Tomorrow!
              </h1>
              <h4 className="mt-3 fw-semibold fst-italic">
                Green. That's how we'd like the world to be
              </h4>
              <p className="mt-4 text-secondary">
                There are many ways to take small steps in changing your living
                habits while making big strides in helping the environment.
              </p>
              <div className="d-flex align-items-center justify-content-start row mt-5">
                <div className="col-md-6 d-flex justify-content-start">
                  <a
                    ...
                    target="blank"
                  >
                    <img src="src/images/vid.png" className="vid" />
                  </a>
                  <a
                    href="https://www.youtube.com/watch?v=OfV3VNgjpvw"
                    target="blank"
                    className="btn color btn-find mt-2 fn"
                  >
                    Watch Video
                  </a>
                  <Link to="/about" className="col-md-3 ms-3">
                    <button className="btn btn-warning color btn-join fw-semibold rounded-pill p-3">
                      FindOutMore
                    </button>
                  </Link>
                </div>
          ...
          <div className="d-flex justify-content-center h-100 align-items-center bgi w-100">
            <div className="w-75 text-white">
              ...
              <p className="mt-4 fw-light">
                ...
                water is 0.002% on Earth. What will you children drink?
              </p>
              <h6 className="mt-5 text-warning fw-semibold">
          ...
          {feature.map((fet, ind) => (
            <div className="col-xxl-3 col-md-6 mt-2" key={ind}>
              <div className="d-block w-75">
                ...
                <p className="text-secondary lh-base fw-light">
                  Water covers two-thirds of the surface of the Earth, but fresh
                  water is 0.002% on Earth. What will you children drink?
                </p>
                <a style={{ textDecoration: "none" }} className="link" href="#">
                  <h6 className={fet.color}>{fet.label}</h6>
                </a>
              </div>
            </div>
          ))}
      ...
      <section
        className="fourth-sec"
        ref={ref1}
        style={{
          opacity: isVisible1 ? 1 : 0,
          transition: "opacity 0.6s ease-out, transform 0.6s ease-out",
          transform: isVisible1 ? "translateX(0)" : "translateX(-500px)",
        }}
      ></section>
          ...
          <div className="w-100 p-5 bg-5 h-100 m-0">
            <div className="d-flex justify-content-center align-items-center h-100">
              <div className="w-75 text-white">
                ...
                <Link to="/join">
                  <p className="mt-5 text-warning fs-5 fw-semibold">Join Us</p>
                </Link>
              </div>
            </div>
          </div>
                  ...
                  <div className="col-xxl-4 col-md-6" key={i}>
                    <div className="card">
                      ...
                      <div className="card-body">
                        <p className="card-title fs-5 color fw-bold mt-2 fm">
                          {c.p}
                        </p>
                        <div className="d-flex justify-content-between mt-3">
                          <span className="text-secondary fst-italic fn">
                            Donated
                          </span>
      ...
      <section
        className="sixth-sec pt-5 pb-5 d-flex align-items-center justify-content-center w-100"
        ref={ref4}
      >
        <div className="row w-70 mt-5 mb-5">
          <div className="img-con col-xxl-4 p-0">
            <img className="img-6" src="src/images/6-2.jpg" alt="" />
          </div>
          <div className="col-xxl-5 content-6 text-white">
            ...
            <p>
              ...
              cubilia Curae. Leo sit met entum cubilia Curae.
            </p>
            <button
              type="button"
              className="btn fw-semibold btn-outline-warning rounded-pill ps-4 pe-4 text-white"
            >
              Donate Now
            </button>
          </div>
          <div className="container col-xxl-3 mt-5 text-center">
            <div
              ...
              style={{
                background: `conic-gradient(rgb(247, 190, 5) calc(${percentage}%), #CC4D39 0)`,
              }}
            >
              <span>
      ...
      <section className="seventh-sec row w-100 m-0 p-0">
        ...
        <div
          className="col-lg-6 h-100 p-0 puzz-5"
          ref={ref2}
          style={{ opacity: isVisible2 ? 1 : 0, transition: "opacity 2s" }}
        >
          <div className="puzz-11 fm">
      ...
      <section
        className="eighth-sec d-flex align-items-center justify-content-center flex-column"
        ref={ref3}
        style={{
      ...
      >
        <div className="w-65">
          <h3 className="text-center fw-bold fst-italic">
            110 million Americans live amongst such high levels of air
            pollution, the federal government considers it to be harmful to
            their health.
          </h3>
          <div className="row m-0 w-100 mt-5">
            ...
            <div className="col-4 text-center">
              ...
              <p className="fs-5">
                are extremely polluted and hence risky for swimming, fishing and
                aquatic life
              </p>
            </div>
            <div className="col-4 text-center">
              ...
              <p className="fs-5">
                in any air, water or soil can cause birth defects, gene mutation
                and cancer
              </p>
            </div>
          </div>
